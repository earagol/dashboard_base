    ...
    <div class="card">
        ...
        <div class="card-body card-block">
            ...
            <div class="form-group">
                ...
                <?php echo $this->Form->control('region_id',['class'=>'form-control','label'=>false]); ?>
            </div>

            <div class="form-group">
                <label for="company" class=" form-control-label">Nombre</label>
                <?php echo $this->Form->control('nombre',['class'=>'form-control','placeholder'=>'Nombres','label'=>false]); ?>
            </div>
