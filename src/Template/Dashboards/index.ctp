                                ...
                                <?php if($clienteTransPen): ?>
                                    <?php foreach ($clienteTransPen as $key => $value) : ?>
                                            <tr>
                                                ...
                                                <td><span class="count"><?php echo $value->_matchingData['Ventas']->monto_transferencia; ?></span></td>
                                                <td> 
                                                    <button class="change badge badge-complete" data-id="<?php echo $value->_matchingData['Ventas']->id; ?>">Cambiar</button>
                                                </td> 
                                            </tr>
                                    <?php endforeach; ?>
                                <?php else: ?>
