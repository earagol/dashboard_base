                        ...
                        <table class="table ">
                            ...
                            <tbody> 
                                <tr>
                                    ...
                                    <td class="avatar">
                                        <div class="round-img">
                                            <a href="#"><?php echo $this->Html->image('images/avatar/1.jpg', ['class' => 'rounded-circle']); ?></a>
                                        </div>
                                    </td>
                                    <td> #5469 </td>
                                ...
                                <tr>
                                    ...
                                    <td class="avatar">
                                        <div class="round-img">
                                            <a href="#"><?php echo $this->Html->image('images/avatar/2.jpg', ['class' => 'rounded-circle']); ?></a>
                                        </div>
                                    </td> 
                                    <td> #5468 </td>
                                ...
                                <tr>
                                    ...
                                    <td class="avatar">
                                        <div class="round-img">
                                            <a href="#"><?php echo $this->Html->image('images/avatar/3.jpg', ['class' => 'rounded-circle']); ?></a>
                                        </div>
                                    </td>
                                    <td> #5467 </td>
                                ...
                                <tr>
                                    ...
                                    <td class="avatar">
                                        <div class="round-img">
                                            <a href="#"><?php echo $this->Html->image('images/avatar/4.jpg', ['class' => 'rounded-circle']); ?></a>
                                        </div>
                                    </td>
                                    <td> #5466 </td>
                                ...
                                <tr class=" pb-0">
                                    ...
                                    <td class="avatar pb-0">
                                        <div class="round-img">
                                            <a href="#"><?php echo $this->Html->image('images/avatar/6.jpg', ['class' => 'rounded-circle']); ?></a>
                                        </div>
                                    </td>
                                    <td> #5465 </td>
                        ...
                        <ul>
                            <li>
                                <div class="msg-received msg-container">
                                    <div class="avatar">
                                       <?php echo $this->Html->image('images/avatar/64-1.jpg'); ?>
                            ...
                            <li> 
                                <div class="msg-sent msg-container">
                                    <div class="avatar">
                                       <?php echo $this->Html->image('images/avatar/64-2.jpg'); ?>
                                       <div class="send-time">11.11 am</div>
                                    </div> 
                                    <div class="msg-box">
                                        <div class="inner-box">
