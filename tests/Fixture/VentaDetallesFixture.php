...
/**
 * VentaDetallesFixture
 *
 */
class VentaDetallesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'venta_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'cantidad' => 1,
                'total' => 1,
                'created' => '2018-11-18 19:45:33',
                'modified' => '2018-11-18 19:45:33',
                'deleted' => '2018-11-18 19:45:33'
            ],
        ];
        parent::init();
    }
