...
/**
 * ControlDeudaPagosFixture
 *
 */
class ControlDeudaPagosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'tipo' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => 'Activo,Pasivo', 'precision' => null, 'fixed' => null],
        ...
        'monto_cheque' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        ...
        'venta_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'usuario_id' => 1,
                'venta_id' => 1,
                'created' => '2018-11-03 19:48:59',
                'modified' => '2018-11-03 19:48:59',
                'deleted' => '2018-11-03 19:48:59'
            ],
        ];
        parent::init();
    }
